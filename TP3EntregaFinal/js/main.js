...
ficha1.addEventListener('click',()=>{
    for(let i = 0; i < juego1.cantFichas();i++){
        juego1.getFicha(i).draw(imgFicha1);
...
ficha2.addEventListener('click',()=>{
    for(let i = 0; i < juego1.cantFichas();i++){
        juego1.getFicha(i).draw(imgFicha2);
...
ficha3.addEventListener('click',()=>{
    for(let i = 0; i < juego1.cantFichas();i++){
        juego1.getFicha(i).draw(imgFicha3);
...
ficha4.addEventListener('click',()=>{
    for(let i = 0; i < juego1.cantFichas();i++){
        juego1.getFicha(i).draw(imgFicha4);
...
ficha5.addEventListener('click',()=>{
    for(let i = 0; i < juego1.cantFichas();i++){
        juego1.getFicha(i).draw(imgFicha5);
...
ficha6.addEventListener('click',()=>{
    for(let i = 0; i < juego1.cantFichas();i++){
        juego1.getFicha(i).draw(imgFicha6);
        imgFichaJugador1 = imgFicha6;
    }
